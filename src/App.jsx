...
export default function App() {
  return (
    <main className="w-full flex flex-col lg:flex-row min-h-screen">
      <header className="flex min-h-screen font-sans w-full p-8 sm:p-16 from-transparent via-transparent to-slate-950 items-center place-content-center">
        <Logo className="w-[60px] stroke-slate-100 stroke-[10px] animate-draw-line fill-mode-forwards repeat-1 absolute top-8 left-8" />
        <hgroup className="max-w-sm md:max-w-2xl flex flex-1 flex-col mx-auto text-center animate-fade-in-up my-32">
          <h1 className="font-black text-slate-100 text-4xl sm:text-5xl md:text-7xl leading-none tracking-tight animate-fade-in-up mb-8 mx-auto">
            Andrew Brice
            <span className="block text-slate-700 text-2xl sm:text-3xl md:text-5xl">
              Software Engineer & Mentor
            </span>
          </h1>
          <p className="font-normal text-slate-100 text-lg sm:text-xl md:text-2xl mb-4 mx-auto">
      ...
      <section className="w-96 flex flex-col justify-center items-center p-8 sm:p-16 bg-slate-950">
        <img
        ...
        <div className="w-full max-w-7xl mx-auto lg:flex-1 flex flex-col">
          ...
          <p className="text-slate-600 text-lg lg:text-xl lg:leading-[1.4] mb-8">
