    ...
    <main className="w-full bg-bg font-sans text-text flex flex-col lg:flex-row">
      <header className="w-full min-h-screen flex flex-col mx-auto p-16 justify-center items-center">
        ...
        <hgroup className="animate-fade-in-up text-center">
          ...
          <h2 className="text-text-alt font-extrabold text-xl lg:text-4xl">
            Software Engineer
          </h2>
        </hgroup>
      </header>
      <article className="w-full bg-white min-h-screen p-16 flex flex-col text-center items-center justify-center">
        ...
        <p className="w-full max-w-md text-text-alt text-base lg:text-lg lg:leading-[1.4] mb-4 lg:mb-8 animate-fade-in-up ">
        ...
        <p className="max-w-md text-text-alt text-base lg:text-lg lg:leading-[1.4] mb-8 animate-fade-in-up">
